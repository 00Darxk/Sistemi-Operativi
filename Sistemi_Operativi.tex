...
%% TODO aggiungere lezioni 30 set; 1 ott

\subsection{Scrittura di File e Chiamate di Sistema}

Si può utilizzare un editor di testo nativo alla command line, accessibile tramite il comando \verb|nano|, per poter creare file C. 
\begin{minted}{powershell}
...
Queste flag possono essere concatenate insieme, tramite l'operatore \verb|||. Si utilizzano le seguenti flag per indicare di troncare il file in caso esista, altrimenti 
di crearlo e di assegnare privilegi di lettura e scrittura al possessore dello stesso. Inoltre si specifica la modalità di accesso: in solo lettura, solo scrittura, oppure 
lettura e scrittura. In questo caso si apre in modalità di sola scrittura:
\begin{minted}{c}
